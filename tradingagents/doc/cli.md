...
query: 列出 tradingagents 模块中读取的关键环境变量（API keys、开关、目录、数据库）以及它们影响的功能路径
...
filePath: e:\workspace\GitRepository\TradingAgents-CN\tradingagents\config\database_manager.py
...
filePath: e:\workspace\GitRepository\TradingAgents-CN\cli\main.py
